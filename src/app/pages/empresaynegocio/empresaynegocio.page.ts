...
@Component({
  selector: 'app-empresaynegocio',
  templateUrl: './empresaynegocio.page.html',
  styleUrls: ['./empresaynegocio.page.scss'],
})
export class EmpresaynegocioPage implements OnInit {
  ...
  abriry() {
    const browser = this.iab.create('https://www.youtube.com/playlist?list=PL5fv2NCPWwYLHiH7GcntsfRMChkhsDiQK','_self', 'location=no');
